...
left:						;LED moving left
	in r25,PINC			    ;r25 will have PINC, bit nr.2 will be the bit we're interested in
	andi r25,0x04			;isolating the push button we care about
	cpi  r25,0x04
	breq left
	...
	;rcall wait_msec
	andi r27,0x04
	cpi r27,0x04 			;check if PC2 is pushed
